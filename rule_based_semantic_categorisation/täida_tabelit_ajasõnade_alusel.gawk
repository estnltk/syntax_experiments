...
NF > 2 && $11=="" {    # liik on veel määramata
    ...
    tyyp = "";
    # tüüpilisemad ajasõnad; õige oleks nad esitada massiivina; siit on puudu aasta-paar, nädal-kaks jms
    ...
    if ($5=="gen" || $5=="<käändumatu>")       # omastav või <käändumatu>   vaikimisi võiks olla mitte-määrus
        ...
        if ($6=="järel")
            ...
            if (ajas[$4] > 1)
                tyyp = "ajam";
            if ($4 ~ /mine$/)   # ...mise järel on alati ajamäärus
                tyyp = "ajam";
            }                    
        if ($6=="eest" || $6=="kanti" || $6=="ligi" || $6=="ümber")
            ;                       # nagunii on ajasõna juba märgitud
    ...
    if ($5 == "term")      # rajav
        ...
        if (ajas[$4] > 4)
            tyyp = "ajam";
        if ($4 ~ /mine$/)   # ...miseni on alati ajamäärus
            tyyp = "ajam";
        }
    if ($5 == "tr")       # saav
        {
