...
* **general** (only carry grammatical meaning, are never arguments): *ADV_modaalsus, ADV_põhjus*
    * accepted addition: *abstr, abstr/konkr*
* **location** : *ADV_koht, koht, koht_suund/asend, abstr_asend/suund*
    * accepted addition: *seisund, ADV_aste, ADV_seisund, ADV_modaalsus, ADV_põhjus*
* **manner**: *ADV_viis, ADV_tulemus*
    * accepted addition: *ADV_aste, ADV_seisund*
* **state**: *ADV_seisund, seisund, seisund_füüs*
    * accepted addition: *ADV_aste, ADV_tulemus*
* **time**: *ADV_aeg, aeg*
    * accepted addition: *omadus_aeg, ADV_aste, ADV_tulemus, ADV_modaalsus*