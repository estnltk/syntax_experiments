...
Depends on the things done in alternative_workflow.

**09_v04_data_extraction_4_gpt_test580.ipynb**: Testing propting with 580 sentences from n80. Uses input file **n80_top29_10p_10n_examples.csv**.
