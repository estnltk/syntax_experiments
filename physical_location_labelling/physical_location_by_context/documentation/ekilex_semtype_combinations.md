...
Obliques have 5 tags: location, time, event, state, not_location. These have been combined from various ekilex semantic_type tags.
...
* **amount**: *Adv_aste*
    * If a word had several semantic types, then the word was considered an amount if one tag was from the list above and the others belonged to the
      semantic types of *abstr/konkr, kogus*
* **general**: *ADV_modaalsus, ADV_põhjus*
    * If a word had several semantic types, then the word was considered a general adverb if one tag was from the list above and the others belonged to       the semantic types of *abstr, abstr/konkr*
* **location** : *ADV_koht, koht, koht_suund/asend, abstr_asend/suund*
    * If a word had several semantic types, then the word was considered a location if one tag was from the list above and the others belonged to the
      semantic types of *seisund, ADV_aste, ADV_seisund, ADV_modaalsus, ADV_põhjus*
* **manner**: *ADV_viis, ADV_tulemus*
    * If a word had several semantic types, then the word was considered a manner if one tag was from the list above and the others belonged to the
      semantic types of *ADV_aste, ADV_seisund*
* **state**: *ADV_seisund, seisund, seisund_füüs*
    * If a word had several semantic types, then the word was considered a state if one tag was from the list above and the others belonged to the
      semantic types of *ADV_aste, ADV_tulemus*
* **time**: *ADV_aeg, aeg*
    * If a word had several semantic types, then the word was considered a time if one tag was from the list above and the others belonged to the
      semantic types of *omadus_aeg, ADV_aste, ADV_tulemus, ADV_modaalsus*