...
* *verb_koht_vs_mittekoht.html*: a hoverplot showing if a verb+case pair's dependents are locations or not and how many of the dependents have been annotated