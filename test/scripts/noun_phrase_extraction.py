...
def extract_noun_phrases(text_obj):
    ...
    return text_obj.obl_phrases, text_obj.nsubj_phrases, text_obj.obj_phrases
...
def create_df(text_id, text_obj):
    text_obj.meta['text_id'] = text_id
    obl_phrases, nsubj_phrases, obj_phrases = extract_noun_phrases(text_obj)
    ...
    return append_data_to_df(obl_phrase_texts+nsubj_phrase_texts+obj_phrase_texts)
