...
class GMExperiment10Tagger(Tagger):
    def __init__(self,
                 output_layer='gm_experiment_10',
                 input_layers=None,
    ...
    def _make_layer(self, text, layers, status=None):
        ...
        for basespan in text[self.input_layers[0]]:
            ...
            attributes = {'id': basespan.id, 'form': basespan.text, 'lemma': 'XX',
                          'upostag': 'XX', 'xpostag': 'XX', 'feats': 'XX', 'head': basespan.head,
    ...
    def __doc__(self):
        print("Experiment 10: alles ainult tekstisõnad (ja sünt märgendid)")
