...
class AMExperiment12_2Tagger(Tagger):
    def __init__(self,
                 output_layer='am_experiment_12_2',
                 input_layers=None,
        ...
        self.conf_param = ['morph_analysis_tagger', 'morph_extended_tagger', 'visl_tagger', 'lemmas_to_keep']
    ...
    def __doc__(self):
        print("Experiment 12_2: kustutatud tekstisõnad ja osad lemmad kustutatud")


def lemmas_to_keep():
    verbs = pickle.load(open("../difficult_constructions/verbs_to_keep_for_subj_obj.pickle", "rb"))
    vpart_verbs = pickle.load(open("../difficult_constructions/vpart_verbs.pickle", "rb"))
    vpart_adverbs = pickle.load(open("../difficult_constructions/vpart_adverbs.pickle", "rb"))
