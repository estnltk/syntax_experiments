from estnltk import Tagger, ElementaryBaseSpan, Annotation, Layer


class GMExperiment2Tagger(Tagger):

    def __init__(self,
                 output_layer='gm_experiment_2',
                 input_layers=None,
    ...
    def __doc__(self):
        print("Experiment 2: kõik lemmad kustutatud")
