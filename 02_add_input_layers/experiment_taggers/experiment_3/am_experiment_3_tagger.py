...
class AMExperiment3Tagger(Tagger):
    def __init__(self,
                 output_layer='am_experiment_3',
                 input_layers=None,
    ...
    def _make_layer(self, text, layers, status=None):
        ...
        for basespan, visl_span in zip(text[self.input_layers[0]], text.visl):
            ...
            attributes = {'id': basespan.id, 'form': basespan.text, 'lemma': lemma,
                          ...
                          'deprel': basespan.deprel[0], 'deps': '_', 'misc': '_'}
    ...
    def __doc__(self):
        print("Experiment 3: nimisõnade ja omadussõnade lemmad kustutatud.")
