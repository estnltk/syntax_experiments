...
parser = argparse.ArgumentParser(description = "Tags layer block with stanza tagger and creates layer 'stanza_syntax_ignore_entity' where the subtrees of given deprel are stored.")
